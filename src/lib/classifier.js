...
- Evidence should be a concise independent clause in third person past tense (e.g. 'built' not 'builds'), paraphrased from the role text. The original meaning must be preserved. Resolve vague references (e.g. 'this workflow', 'our team') using specific terms from the role text. Do not fabricate outcomes not stated in the role text. Hard limit: 120 characters per snippet — when cutting for length, remove section headers, first-person subjects, possessives, quantifiers with no semantic value (e.g. 'both'), redundant adjectives, and trailing context that restates something already implied. When a source bullet has two clauses joined by 'and' or ';': keep the second only if it names a distinct activity, outcome, or framework — cut it if it merely explains, qualifies, or elaborates the first. Preserve specific metrics, named programs or frameworks, action verbs that convey the nature of the work, and any noun or phrase that establishes why the activity belongs to this label.
- Before writing evidence for a label, verify the activity described genuinely falls within that knowledge area's occupational domain — not just its subject matter or thematic context.
