    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav { background: #2c3038; border-bottom: 0.5px solid #404850; }
        ...
        .hero { background: #faf8f4; border-bottom: 0.5px solid #d8d0c4; }
        .hero .inner { padding: 56px 48px; display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center; }
        .eyebrow { font-size: 10px; font-weight: 700; letter-spacing: .16em; text-transform: uppercase; color: #904060; margin-bottom: 12px; }
        .hero h1 { font-size: 34px; font-weight: 700; color: #1a1410; line-height: 1.25; margin-bottom: 16px; }
        .hero p { font-size: 14px; color: #706050; line-height: 1.8; margin-bottom: 24px; }
        .btn-primary { display: inline-block; background: #904060; color: #fff; font-size: 12px; font-weight: 700; padding: 11px 24px; border-radius: 3px; text-decoration: none; border: none; cursor: pointer; }
        .btn-primary:hover { background: #7a3452; }
        .sub { font-size: 11px; color: #a09080; margin-top: 10px; }
        ...
        .how { background: #faf8f4; border-bottom: 0.5px solid #d8d0c4; }
        ...
        .step-title { font-size: 15px; font-weight: 700; color: #1a1410; margin-bottom: 8px; }
        .step-body { font-size: 13px; color: #706050; line-height: 1.75; }

        .taxonomy { background: #2c3038; border-bottom: 0.5px solid #404850; }
        ...
        .taxonomy .section-intro { font-size: 14px; color: #909aa8; line-height: 1.8; margin-bottom: 40px; max-width: 600px; }
        .dims { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; }
        .dim { background: #363c44; border-radius: 6px; padding: 20px 22px; border: 0.5px solid #404850; }
        ...
        .dim-body { font-size: 13px; color: #808898; line-height: 1.7; }

        .recruiter { background: #f0ece4; border-bottom: 0.5px solid #d8d0c4; }
        .recruiter .inner { padding: 64px 48px; display: grid; grid-template-columns: 1fr 1fr; gap: 56px; align-items: center; }
        .recruiter .section-eyebrow { color: #904060; }
        .recruiter h2 { font-size: 26px; font-weight: 700; color: #1a1410; margin-bottom: 14px; line-height: 1.3; }
        .recruiter p { font-size: 14px; color: #706050; line-height: 1.8; margin-bottom: 24px; }
        .recruiter-features { display: flex; flex-direction: column; gap: 16px; }
        ...
        .rf-title { font-size: 13px; font-weight: 700; color: #1a1410; margin-bottom: 3px; }
        .rf-body { font-size: 12px; color: #706050; line-height: 1.6; }

        .data { background: #faf8f4; border-bottom: 0.5px solid #d8d0c4; text-align: center; }
        .data .inner { padding: 56px 48px; }
        .data-title { font-size: 22px; font-weight: 700; color: #1a1410; margin-bottom: 6px; }
        .data-sub { font-size: 14px; color: #706050; margin-bottom: 36px; }
        ...
        .dp-title { font-size: 13px; font-weight: 700; color: #1a1410; margin-bottom: 5px; }
        .dp-body { font-size: 12px; color: #a09080; line-height: 1.65; }
        ...
        @media (max-width: 700px) {
          ...
          .hero .inner { padding: 32px 20px; grid-template-columns: 1fr; gap: 32px; }
          .how .inner { padding: 40px 20px; }
          .steps { grid-template-columns: 1fr; gap: 28px; }
          .taxonomy .inner { padding: 40px 20px; }
          .dims { grid-template-columns: 1fr; }
          .recruiter .inner { padding: 40px 20px; grid-template-columns: 1fr; }
